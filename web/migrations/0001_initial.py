# -*- coding: utf-8 -*-
# Generated by Django 1.11.18 on 2019-04-21 02:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('0', '在线'), ('1', '离线'), ('2', '维修'), ('3', '停用')], default='0', max_length=64, verbose_name='主机状态')),
                ('environment', models.CharField(choices=[('0', '测试'), ('1', '开发'), ('2', '预生产'), ('3', '生产')], default='3', max_length=64, verbose_name='主机环境')),
            ],
        ),
        migrations.CreateModel(
            name='HostIssue',
            fields=[
                ...
                ('status', models.CharField(choices=[('0', '等待发布'), ('1', '发布中'), ('2', '等待测试'), ('3', '测试通过'), ('4', '发布成功'), ('5', '失败'), ('6', '回滚失败'), ('7', '回滚成功')], default='0', max_length=64, verbose_name='更新状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('0', '文件'), ('1', 'git')], default='0', max_length=50, verbose_name='更新类型')),
                ('status', models.CharField(choices=[('0', '等待发布'), ('1', '发布中'), ('2', '等待测试'), ('3', '测试通过'), ('4', '发布成功'), ('5', '失败'), ('6', '回滚失败'), ('7', '回滚成功')], default='0', max_length=64, verbose_name='更新状态')),
