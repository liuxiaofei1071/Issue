...
from web.views import user, host, cron, team, command, init, initlog, issue
...
urlpatterns = [
    ...
    # 发布
    url(r'^update_list/', issue.update_list, name='update_list'),
    url(r'^rollback_list/', issue.rollback_list, name='rollback_list'),
    url(r'^create_git/', issue.create_git, name='create_git'),
    url(r'^get_bra/(?P<pk>\d+)', issue.get_bra, name='get_bra'),

    # url(r'^get_bra/(?P<pk>\d+)', issue.get_bra, name='get_bra'),
    # url(r'^get_tag/(?P<pk>\d+)', issue.get_bra, name='get_tag'),
    # url(r'^get_commit/(?P<pk>\d+)', issue.get_bra, name='get_commit'),
